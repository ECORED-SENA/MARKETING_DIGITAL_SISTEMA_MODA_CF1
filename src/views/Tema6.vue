...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos relacionados con el posicionamiento de la marca
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de las ventas y la participación en el mercado
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de visibilidad y publicidad
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de ventajas y características competitivas
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de costo, rentabilidad y eficiencia logística
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de satisfacción del cliente
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de canales de distribución
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos de marca y actividades de punto de venta
    ...
    .row.align-items-center
      ...
      .col-lg-10
        .h5 Elementos con el nivel de recomendación (NPS)
        p Medir la lealtad y  la satisfacción del cliente permite generar mejores prácticas en términos de experiencias.
